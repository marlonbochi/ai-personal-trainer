...
export const aboutTranslations = {
  ...
  appDescription: 'AI Trainer is an innovative application designed to help you achieve your fitness goals through personalized workout and nutrition plans. Our AI-powered platform creates customized fitness routines and meal plans tailored to your specific needs, preferences, and goals.',
  aboutMe: 'About Me',
  myDescription: 'Hello! I\'m a passionate developer and fitness enthusiast who created this app to combine my love for technology and health. My goal is to make fitness accessible and personalized for everyone, using the power of AI to create effective workout and nutrition plans.',
